/*
  SRT Ticket Tools – Correctness Patch v4
  ใช้กับ index.html เดิม โดยวางไฟล์นี้ไว้โฟลเดอร์เดียวกัน
  และเพิ่ม <script src="booking-fix-v4.js"></script> หลัง </script> เดิม ก่อน </body>
*/
(() => {
  'use strict';
  ...
  function professionalizeNotices() {
    ...
    if (info) {
      info.innerHTML = `
        ...
        <span class="patch-version">PATCH v4</span>
      `;
    }
  ...
  function init() {
    ...
    console.info('SRT Ticket Tools: Correctness Patch v4 loaded');
  }
